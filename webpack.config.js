...
const entry = {
    'elementor-widget/index': SRC_DIR + '/elementor-widget/index.js',
    'elementor-editor/index': SRC_DIR + '/elementor-editor/index.js',
    'admin/index': SRC_DIR + '/admin/index.js',
    // CSS-only entries (if you have separate CSS files)
    'font-icons/index': SRC_DIR + '/font-icons/index.scss',
    'main/index': SRC_DIR + '/main/index.scss',
};
...
module.exports = {
    ...
    ...{
        ...
        plugins: [
            ...
            // Re-add RTL CSS processing for your widget
            new RtlCssPlugin({
