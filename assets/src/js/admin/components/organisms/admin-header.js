...
// Define ElementifyAddonsLocalize if not already defined
const ElementifyAddonsLocalize = window.ElementifyAddonsLocalize || {};
...
const AdminHeader = (props) => {
	...
	return (
		<AtrcWrap
			...
			{...defaultProps}
		>
			<AtrcWrap className="at-ctnr-fld">{renderHeaderContent()}</AtrcWrap>
		</AtrcWrap>
	);
};
