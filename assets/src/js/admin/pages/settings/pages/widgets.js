		...
		<AtrcContent>
			...
			<AtrcPanelRow>
				<AtrcControlToggle
					...
					onChange={() =>
						dbUpdateSetting('form_styler', !isFormStylerEnabled)
					}
				/>
			</AtrcPanelRow>
			<AtrcPanelRow>
			...
			<AtrcPanelRow>
				<AtrcControlToggle
					...
					onChange={() =>
						dbUpdateSetting('testimonials', !isTestimonialsEnabled)
					}
				/>
			</AtrcPanelRow>
			<AtrcPanelRow>
				<AtrcControlToggle
					...
					onChange={() =>
						dbUpdateSetting('portfolio', !isPortfolioEnabled)
					}
				/>
			</AtrcPanelRow>
		</AtrcContent>
...
const Settings = () => {
	...
	return (
		<AtrcWireFrameHeaderContentFooter
			...
			renderHeader={
				<AtrcTitleTemplate1
					title={__('Widgets', 'elementify-addons-for-elementor')}
				/>
			}
			renderContent={
				<AtrcWireFrameContentSidebar
