...
const HoverDropdown = ({ children }) => {
	...
	return (
		<div className="ele-dropdown-container" onMouseLeave={handleMouseLeave}>
			<Button
				ref={buttonRef}
				variant="secondary"
			...
			>
				{isVisible
					? __('Close Filter', 'elementify-addons-for-elementor')
					: __('Open Filter', 'elementify-addons-for-elementor')}
			</Button>
			{isVisible && (
				<Popover
